    ...
    <ScrollReveal className="w-full py-24 bg-white border-t border-neutral-100 flex flex-col items-center justify-center">
      <div className="max-w-[1200px] w-full px-6 flex flex-col gap-16">
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 w-full items-stretch">
          ...
          <div className="flex flex-col gap-8 p-8 md:p-10 rounded-2xl bg-neutral-50/50 border border-neutral-200/60">
            <h3 className="text-xl md:text-2xl font-bold !text-neutral-500 font-space-grotesk tracking-tight uppercase border-b border-neutral-200 pb-4">
              ...
              {traditionalItems.map((item, idx) => (
                <div key={`trad-${idx}`} className="flex gap-4 items-start">
                  ...
                  <div className="flex flex-col gap-1">
                    <h4 className="text-base font-semibold !text-neutral-600 font-space-grotesk">
                      {item.title}
                    </h4>
          ...
          <div className="hidden lg:flex absolute left-1/2 top-0 bottom-0 -translate-x-1/2 flex-col items-center justify-center pointer-events-none">
            <div className="w-[1px] h-full bg-gradient-to-b from-transparent via-neutral-300 to-transparent" />
            <motion.div
              animate={{
                scale: [1, 1.08, 1],
                boxShadow: [
              ...
              className="absolute w-12 h-12 rounded-full border border-neutral-200 bg-white flex items-center justify-center text-sm font-bold !text-neutral-900 pointer-events-auto select-none font-space-grotesk shadow-md"
            >
              VS
            </motion.div>
          </div>
          ...
          <div className="flex lg:hidden items-center justify-center w-full my-4 relative h-12">
            <div className="absolute w-full h-[1px] bg-gradient-to-r from-transparent via-neutral-300 to-transparent" />
            <motion.div
              animate={{
                scale: [1, 1.08, 1],
                boxShadow: [
                  "0 0 12px rgba(10, 102, 245, 0.2)",
                  "0 0 20px rgba(10, 102, 245, 0.4)",
                  "0 0 12px rgba(10, 102, 245, 0.2)"
                ]
              }}
              transition={{
              ...
              className="relative z-10 w-10 h-10 rounded-full border border-neutral-200 bg-white flex items-center justify-center text-xs font-bold !text-neutral-900 select-none font-space-grotesk shadow-sm"
            >
              VS
            </motion.div>
          </div>
          ...
          <div className="flex flex-col gap-8 p-8 md:p-10 rounded-2xl bg-[#0B1120] border border-white/10 shadow-xl">
